...
export function useMyPageData() {
    ...
    return { trips, playlists, loading, error, clearError: (): void => setError(null), deleteTrip, deletePlaylist };
}
...
export function useTripSchedules(tripId: number | null) {
    ...
    return { schedules, error, clearError: (): void => setError(null), refetch };
}