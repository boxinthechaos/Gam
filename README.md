...
<img width="880" height="530" alt="스크린샷 2026-03-26 165843" src="https://github.com/user-attachments/assets/9c7ebedc-161c-4dbf-8809-ffee5a0ed4e8" /><br>
- 해결방법 : Spring Boot의 `Async`어노테이션 활용 하여 백그라운드 스레드에서 비동기로 처리하도록 리펙토링<br>
